...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_DEMO_LIST:
    case types.API_V1_DEMO_LIST_SUCCEEDED:
    case types.API_V1_DEMO_LIST_FAILED:
    case types.API_V1_DEMO_CREATE:
    case types.API_V1_DEMO_CREATE_SUCCEEDED:
    case types.API_V1_DEMO_CREATE_FAILED:
    case types.API_V1_DEMO_READ:
    case types.API_V1_DEMO_READ_SUCCEEDED:
    case types.API_V1_DEMO_READ_FAILED:
    case types.API_V1_DEMO_UPDATE:
    case types.API_V1_DEMO_UPDATE_SUCCEEDED:
    case types.API_V1_DEMO_UPDATE_FAILED:
    case types.API_V1_DEMO_PARTIAL_UPDATE:
    case types.API_V1_DEMO_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_DEMO_PARTIAL_UPDATE_FAILED:
    case types.API_V1_DEMO_DELETE:
    case types.API_V1_DEMO_DELETE_SUCCEEDED:
    case types.API_V1_DEMO_DELETE_FAILED:
