...
export const api_v1_demo_list = () => ({ type: types.API_V1_DEMO_LIST })
export const api_v1_demo_listSucceeded = response => ({
  type: types.API_V1_DEMO_LIST_SUCCEEDED,
  response
})
export const api_v1_demo_listFailed = error => ({
  type: types.API_V1_DEMO_LIST_FAILED,
  error
})
export const api_v1_demo_create = () => ({ type: types.API_V1_DEMO_CREATE })
export const api_v1_demo_createSucceeded = response => ({
  type: types.API_V1_DEMO_CREATE_SUCCEEDED,
  response
})
export const api_v1_demo_createFailed = error => ({
  type: types.API_V1_DEMO_CREATE_FAILED,
  error
})
export const api_v1_demo_read = () => ({ type: types.API_V1_DEMO_READ })
export const api_v1_demo_readSucceeded = response => ({
  type: types.API_V1_DEMO_READ_SUCCEEDED,
  response
})
export const api_v1_demo_readFailed = error => ({
  type: types.API_V1_DEMO_READ_FAILED,
  error
})
export const api_v1_demo_update = () => ({ type: types.API_V1_DEMO_UPDATE })
export const api_v1_demo_updateSucceeded = response => ({
  type: types.API_V1_DEMO_UPDATE_SUCCEEDED,
  response
})
export const api_v1_demo_updateFailed = error => ({
  type: types.API_V1_DEMO_UPDATE_FAILED,
  error
})
export const api_v1_demo_partial_update = () => ({
  type: types.API_V1_DEMO_PARTIAL_UPDATE
})
export const api_v1_demo_partial_updateSucceeded = response => ({
  type: types.API_V1_DEMO_PARTIAL_UPDATE_SUCCEEDED,
  response
})
export const api_v1_demo_partial_updateFailed = error => ({
  type: types.API_V1_DEMO_PARTIAL_UPDATE_FAILED,
  error
})
export const api_v1_demo_delete = () => ({ type: types.API_V1_DEMO_DELETE })
export const api_v1_demo_deleteSucceeded = response => ({
  type: types.API_V1_DEMO_DELETE_SUCCEEDED,
  response
})
export const api_v1_demo_deleteFailed = error => ({
  type: types.API_V1_DEMO_DELETE_FAILED,
  error
})
