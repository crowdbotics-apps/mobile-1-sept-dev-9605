...
function* api_v1_demo_listWorker(action) {
  try {
    const result = yield call(apiService.api_v1_demo_list, action)
    yield put(actions.api_v1_demo_listSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_demo_listFailed(err))
  }
}
function* api_v1_demo_listWatcher() {
  yield takeEvery(types.API_V1_DEMO_LIST, api_v1_demo_listWorker)
}
function* api_v1_demo_createWorker(action) {
  try {
    const result = yield call(apiService.api_v1_demo_create, action)
    yield put(actions.api_v1_demo_createSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_demo_createFailed(err))
  }
}
function* api_v1_demo_createWatcher() {
  yield takeEvery(types.API_V1_DEMO_CREATE, api_v1_demo_createWorker)
}
function* api_v1_demo_readWorker(action) {
  try {
    const result = yield call(apiService.api_v1_demo_read, action)
    yield put(actions.api_v1_demo_readSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_demo_readFailed(err))
  }
}
function* api_v1_demo_readWatcher() {
  yield takeEvery(types.API_V1_DEMO_READ, api_v1_demo_readWorker)
}
function* api_v1_demo_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_demo_update, action)
    yield put(actions.api_v1_demo_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_demo_updateFailed(err))
  }
}
function* api_v1_demo_updateWatcher() {
  yield takeEvery(types.API_V1_DEMO_UPDATE, api_v1_demo_updateWorker)
}
function* api_v1_demo_partial_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_demo_partial_update, action)
    yield put(actions.api_v1_demo_partial_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_demo_partial_updateFailed(err))
  }
}
function* api_v1_demo_partial_updateWatcher() {
  yield takeEvery(
    types.API_V1_DEMO_PARTIAL_UPDATE,
    api_v1_demo_partial_updateWorker
  )
}
function* api_v1_demo_deleteWorker(action) {
  try {
    const result = yield call(apiService.api_v1_demo_delete, action)
    yield put(actions.api_v1_demo_deleteSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_demo_deleteFailed(err))
  }
}
function* api_v1_demo_deleteWatcher() {
  yield takeEvery(types.API_V1_DEMO_DELETE, api_v1_demo_deleteWorker)
}
...
export default function* rootSaga() {
  const sagas = [
    ...
    api_v1_demo_listWatcher,
    api_v1_demo_createWatcher,
    api_v1_demo_readWatcher,
    api_v1_demo_updateWatcher,
    api_v1_demo_partial_updateWatcher,
    api_v1_demo_deleteWatcher,
